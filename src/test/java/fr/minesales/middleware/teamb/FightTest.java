...
import fr.minesales.middleware.teamb.entities.Fight;
...
public class FightTest {
    ...
    @Test
    public void ConstructorTestNoArgThrowException() {
        //0 args NOT OK
        Assertions.assertThrows(IllegalArgumentException.class, Fight::new);
    }
    ...
    public void ConstructorTest() {
        ...
        Assertions.assertEquals(2, fight.getFighters().length);
    }
    ...
    public void WinnerTest(){
        ...
        Hero h11 = heroFactory.createHero("h11", s1.getBelief(), 100, 100, 100);
        Hero h12 = heroFactory.createHero("h12", s1.getBelief(), 50, 50, 50);
        Hero h21 = heroFactory.createHero("h21", s2.getBelief(), 10, 10, 10);
        Hero h22 = heroFactory.createHero("h22", s2.getBelief(), 5, 5, 5);
